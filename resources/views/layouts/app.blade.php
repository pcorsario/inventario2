        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="https://itsjapon.edu.ec/wp-content/uploads/2022/02/LOGO-HERALDICO-color1.png" width="150" height="75" alt="" srcset="">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
						...
						<li class="nav-item">
                            <a href="{{ url('/plantas') }}" class="nav-link"><i class="fab fa-laravel text-info"></i> Plantas</a> 
                        </li>
						<li class="nav-item">
                            <a href="{{ url('/sedes') }}" class="nav-link"><i class="fab fa-laravel text-info"></i> Sedes</a> 
                        </li>
						<li class="nav-item">
						...
						<li class="nav-item">
                            <a href="{{ url('/condicions') }}" class="nav-link"><i class="fab fa-laravel text-info"></i> Condicion</a> 
                        </li>
